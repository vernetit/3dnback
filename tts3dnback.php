...
<html>
   <head>
      <meta charset="utf-8">
      <title>Text to speech 3D Dual N-Back</title>

    <meta name="description" content="Text to speech 3D Dual N-back: Train your mind in 3D">
...
function iniciar()
{
  ...
  // var plane = Phoria.Util.generateTesselatedPlane(8,8,0,20);
   ...
   if(isAndroid){
    ...
    console.log(_cw);
    $("#controls-l").css("width",_cw+"px"); $("#controls-l").css("height",_wh+"px"); $("#controls-l").css("display","flex");
    $("#controls-r").css("width",_cw+"px"); $("#controls-r").css("height",_wh+"px"); $("#controls-r").css("display","flex");
    
    
    $("#controls-l").html(`<div style="align-self: center; margin-left: 40%;">A</div>`);
    $("#controls-r").html(`<div style="align-self: center; margin-left: 50%;">S</div>`);
   }
   ...
   <body style="background-color: #bfbfbf">
      ...
      <div>
         ...
         <select id="tipoSonido" style="width: 75px;">
          ...
          <option value="3" selected>RAE</option>      
        </select>&nbsp;
        ...
        <span style="display: none;">Tc <input type="checkbox" value="1" id="threeCombination">&nbsp;</span>
      ...
      <!-- Canvas - Resultados -->
      <div>
        <div style="float: left;"  id="controls-l"></div>
        <div style="float: left;">
          <canvas id="canvas" width="768" height="512" style="background-color: #eee"></canvas>
        </div>
        <div style="float:left; width:100px; margin-left: 10px;" id="controls-r">
