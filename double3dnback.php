...
<html>
   <head>
      <meta charset="utf-8">
      <title>Double Position 3D N-Back</title>

    <meta name="description" content="Double Position N-back: Train your mind in 3D">
...
var canvas, canvas1, renderer, renderer1;
function iniciar()
{
  ...
  //cargarResultados();
   ...
   //console.log(scene1.viewport.height);
...
var salidas = [], salidas1 = [], salidas2 = [], salidas3 = [], cantidadBack=2, pasadas=36, currentPasada=0;
...
var tipoCameraVal=0, tipoCameraVal1=0;
var rrrr,rrrx;
var rndPorcentaje=0;
var perdidas=0;
var killCamera1;
...
function start(xxx){
   ...
   if(pasadas==0){
     $("#stop1").hide();
      ...
      if(ok1!=0 || error1!=0){
        ...
        soundTxt="positions R: "+ok1+"-"+error1;
  ...
  */
   ...
   setTimeout(function(){limpiarCubos(); limpiarCubos1();},myInterval1);
  ...
  ga('send', 'pageview');
   ...
   <body style="background-color: #bfbfbf">
      ...
      <div>
         ...
         <span>t: <input type="text" value="3000" id="timeValue" style="width: 35px;">&nbsp;<input type="text" value="500" id="timeValue1" style="width: 30px;"></span>&nbsp;
        ...
        v: <input type="text" value="180" id="camVelocity" style="width: 30px;">&nbsp;
      ...
      <center>
        ...
        <input type="button" value="L: Position Match R" id="pm1" style="">
